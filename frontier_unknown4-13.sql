...
INSERT INTO `ammo` (`ammo_id`, `damage_type`, `fire_rate_mod`, `damage_mod`, `speed_mod`, `range_mod`) VALUES
(1156, 'energy', 20, 15, 100, 200),
(6549, 'energy', 0, 150, 400, 1500),
(4462, 'energy', 10, 10, 200, 500),
(1301, 'projectile', 300, 50, 50, 0),
(5153, 'projectile', 0, 75, 0, 300),
(9764, 'projectile', 30, 5, 50, 500),
(1546, 'projectile', 0, 0, 0, 3000);
...
INSERT INTO `weapon` (`weapon_id`, `weapon_name`, `speed`, `fire_rate`, `slot_size`, `weapon_range`, `damage`) VALUES
(1001, 'plasma', 100, 180, 10, 15000, 50),
(1002, 'beam', 2000, 15, 35, 500, 200),
(1003, 'EMP', 500, 1, 15, 1000, 100),
(1004, 'shells', 800, 600, 35, 1100, 20),
(1005, 'flak', 700, 120, 20, 2000, 20),
(1006, 'missiles', 1200, 60, 50, 3000, 80),
(1007, 'gauss', 2200, 6, 75, 6000, 200);
COMMIT;
